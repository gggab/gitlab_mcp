...
- Personal-token onboarding exports the PAT to the installer process before `claude mcp add-json`, because Claude Code validates environment-variable references while parsing MCP configuration; native command failures must stop the script.
